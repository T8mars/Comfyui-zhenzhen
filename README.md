...
新增贞贞的平价AI小屋独立节点：
支持 `hailuo-h3-max-t2v` 文生视频和 `hailuo-h3-max-i2v` 首尾帧图生视频。
支持 5 到 15 秒、480P/768P；文生视频提供固定比例选择，图生视频支持必填首帧和可选尾帧。
新增 2 份对应工作流，APIKEY 和运行结果均不写入工作流。
...
新增seed audio 1.0配套工作流  

### 20260713-1

去掉之前新增的依赖
新增happ horse 1.1 T2V/I2V/R2V模型（贞贞的平价AI小屋（国内版））  
新增字节最新seed-audio 1.0模型（贞贞的平价AI小屋（国内版））  
...
新增image2-4K专属分组0.08积分  

关于大家关心的gpt-image-2的2K，4K我们一直在努力优化，目前可用4K分组包含长期稳定备用的FAL模型，微软的azure特价组，以及今天重新恢复的default分组及新增的image2-4K专属分组  
...
新增gpt-image-2-vip模型，支持2K,4K，0.1积分，目前稳定，出图极速
...
新增工作流：zhenzhen-gpt-image-2-official_ratio_stable-自定义尺寸.json

### 20260519-1

新增Comfly_gpt_image_2_official_ratio_stable节点
...
上个版本gpt-image-2-all模型代码未正确推送，已修复
...
更新gpt-image-2-official-ratio的分辨率逻辑，修复一些错误

新增default分组直接支持2K，4K，只需要0.04积分（未实装，正在做最后处理）
