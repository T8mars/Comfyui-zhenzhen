...
贞贞工坊通知，sora2已恢复！sora2 现在先用统一格式，sora2 现在先用统一格式，令牌选择 openai 官方优质分组，0.4 算力一次（目前是 12s，0.4 算力一次（按次，不是按秒计算，放心），晚点会有其他的，先用这个顶下，速度大概 3-6 分钟）不要用真人图片，否则会触发系统拦截，非按秒计算，如果使用comfyui节点的，用原本的节点，模型用sora-2，时间选择15秒，实际生成是12秒，务必注意一定要用统一格式，网站左侧API文档里有！另外还有稳定版的15秒方案，目前正在改接口，尽快上线，节点：https://github.com/T8mars/Comfyui-zhenzhen

应急使用教程：https://www.bilibili.com/video/BV1Mi6YBuEKm/
